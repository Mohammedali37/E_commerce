...
<form action="@if(isset($user)) {{route('admin.profile.update', $user)}} @else {{route('admin.profile.store')}} @endif" method="post" enctype="multipart/form-data">
   <div class="row">
    @csrf
	@if(isset($user))
	@method('PUT')
    ...
    <div class="col-lg-9">
        ...
        <div class="form-group row">
                ...
                <div class="col-lg-12">
                    <label class="from-control-label">Email :</label>
		...
		<div class="form-group row">
			...
			<div class="col-sm-12 col-md-6">
				<label class="form-control-label">Re_Type Password :</label>
				<input type="password" id="password_confrim" name="password_confirm" class="form-control">
			</div>
